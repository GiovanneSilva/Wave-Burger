-- Etapa 16 (parte 2): tabelas e colunas que dependem dos valores de enum
-- adicionados em 20260817220000_sales (SALE, VENDAS) — precisa rodar em
-- transacao separada, depois daquela ser commitada.
